...
// Set GPIO
 ...
 pinMode(4,INPUT  );    // step sw );
 pinMode(mode_sw, INPUT);
 pinMode(6,INPUT);      // pinMode on mem sw);  
 pinMode(pin_A, INPUT);
 pinMode(pin_B, INPUT);
...
//  SetFrequency(frq);                   // Set TX-Frequency 
  ...
  si5351.init(SI5351_CRYSTAL_LOAD_8PF, 0, 120000);                                // run config routine to find the correction factor

  si5351.drive_strength(SI5351_CLK0,SI5351_DRIVE_8MA);                          //  power adjust normally 8ma , 2ma , 4ma or 6ma avalible
  si5351.drive_strength(SI5351_CLK1,SI5351_DRIVE_8MA);                          //  power adjust normally 8ma , 2ma , 4ma or 6ma avalible
...
//  Serial.println(cnt);
 ...
 // check if the mode sw has changed. If it has, the mode State is HIGH:
  if (mode_State == HIGH)  {
// GO lsb
            si5351.set_freq((frq + iffreq_lsb) * 100ULL, SI5351_CLK0);//.............................vforx
            si5351.set_freq((frq + iffreq_lsb) * 100ULL, SI5351_CLK1);//.............................vfotx
            si5351.set_freq(iffreq_lsb * 100ULL, SI5351_CLK2);//.....................................cio control
           
} else {

           si5351.set_freq((frq + iffreq_usb) * 100ULL, SI5351_CLK0);//..........................vforx
           si5351.set_freq((frq + iffreq_usb) * 100ULL, SI5351_CLK1);//..........................vfotx
